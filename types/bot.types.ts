 ...
 */
export type MessageDecoratorOptions = [messageOptions?: BotMessageOptions, command?: string, description?: string];
/**
 * @param {BotMessageOptions} messageOptions message options
 * @param {string} command query like "Reg"
 */
export type QueryDecoratorOptions = MessageDecoratorOptions extends [...infer Rest, unknown?] ? Rest : never;
